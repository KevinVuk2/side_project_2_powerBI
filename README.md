...
Data Model:
A star-schema structure connecting fact tables such as:
...
Campaign ID mapping based on date ranges

Top N (Top 5 / Bottom 5) ranking & table generation

Linear baseline metrics (e.g., average orders per week/month)
